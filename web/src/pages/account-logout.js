                    ...
                    <Fragment>
                        ...
                        <div className='col-xs-12 col-md-8' style={{float: 'none', margin: '0 auto', top: -56}}>
                            <Paper style={{padding: 45, color: '#777', textAlign: "center"}}>
                                ...
                                <br />
                                <b>
                                    با خروج از حساب، شما نمی‌توانید از خدمات ما بهره مند شوید. البته حساب شما و همچنین اطلاعات و سفارشات شما همچنان ذخیره هستند.
                                    <br/>
