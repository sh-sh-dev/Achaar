        ...
        <md-content class="md-elevation-5">
            <form @submit.prevent='handleSubmit' v-if='mode === "write"'>
                <md-toolbar class="md-dense">
                    ...
                    <div class="md-title">ورود به حساب</div>
                </md-toolbar>
                <div style='padding: 16px 30px;'>
                    ...
                    <div style="text-align: center; margin: 0 16px">
                        <md-button :disabled='!validation.number || !validation.pass' type="submit" class="md-raised md-primary" style='width: 100%; margin:0'>
                            ورود
                        </md-button>
                    </div>
                </div>
...
export default {
    ...
    metaInfo: {
        title: 'ورود به حساب کاربری | آچار'
    },
    computed: {
        validation(){
            return {
